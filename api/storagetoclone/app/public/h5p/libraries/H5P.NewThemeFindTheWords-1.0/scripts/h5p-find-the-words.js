H5P.NewThemeFindTheWords = (function ($, UI) {
  ...
  /**
   * NewThemeFindTheWords.
   * @class H5P.NewThemeFindTheWords
   * @extends H5P.EventDispatcher
   * @param {Object} options
   * @param {number} id
   * @param {Object} extras
   */
  function NewThemeFindTheWords(options, id, extras) {

    /** @alias H5P.NewThemeFindTheWords# */
    this.id = id;
    this.extras = extras;
    this.numFound = 0;
    ...
    this.grid = new NewThemeFindTheWords.WordGrid(this.gridParams);
    this.vocabulary = new NewThemeFindTheWords.Vocabulary(
  ...
  NewThemeFindTheWords.prototype = Object.create(H5P.EventDispatcher.prototype);
  NewThemeFindTheWords.prototype.constructor = NewThemeFindTheWords;
   ...
   * registerDOMElements.
   */
  NewThemeFindTheWords.prototype.registerDOMElements = function () {
    const that = this;
    ...
    this.timer = new NewThemeFindTheWords.Timer(this.$timer.find('.h5p-time-spent'));
    ...
    this.counter = new NewThemeFindTheWords.Counter(this.$counter.find('.h5p-counter'));
   ...
   */
  NewThemeFindTheWords.prototype.createButton = function (name, icon, param, callback) {
   ...
   */
  NewThemeFindTheWords.prototype.calculateElementSize = function () {
   ...
   */
  NewThemeFindTheWords.prototype.setVocabularyMode = function () {
    const gridCol = this.grid.wordGrid[0].length;
   ...
   */
  NewThemeFindTheWords.prototype.gameSubmitted = function () {
   ...
   */
  NewThemeFindTheWords.prototype.showSolutions = function () {
    this.grid.disableGrid();
   ...
   */
  NewThemeFindTheWords.prototype.resetTask = function () {
    this.numFound = 0;
    this.timer.reset();
    this.counter.reset();
   ...
   * @return {boolean}
   */
  NewThemeFindTheWords.prototype.getAnswerGiven = function () {
   ...
   * @return {number}
   */
  NewThemeFindTheWords.prototype.getScore = function () {
   ...
   * @return {number}
   */
  NewThemeFindTheWords.prototype.getMaxScore = function () {
   ...
   */
  NewThemeFindTheWords.prototype.getXAPIData = function () {
    const xAPIEvent = this.createXAPIEventTemplate('answered');
    this.addQuestionToXAPI(xAPIEvent);
    this.addResponseToXAPI(xAPIEvent);
    return {
   ...
   */
  NewThemeFindTheWords.prototype.addQuestionToXAPI = function (xAPIEvent) {
   ...
   * @param {H5P.XAPIEvent} xAPIEvent
   */
  NewThemeFindTheWords.prototype.addResponseToXAPI = function (xAPIEvent) {
   ...
   * registerGridEvents.
   */
  NewThemeFindTheWords.prototype.registerGridEvents = function () {
    const that = this;
   ...
   */
  NewThemeFindTheWords.prototype.attach = function ($container) {
