H5P.InteractiveVideoSlider = (function (EventDispatcher) {
  ...
  function Column(params, id, data) {
    ...
    var createHTML = function () {
      // Create wrapper
      console.log(params.content[0].subContentId);
      ...
      wrapper1.id = 'slider-custom-'+ params.content[0].subContentId
      ...
      btn.onclick = function(){
        click_show_more(params,wrapper1);return false;
      };
      ...
      process_runable(params,0,wrapper1);
     
    };


    function process_runable (params, inc_var,wrapper1) {
      var iter = 0;
      console.log(inc_var);
      for (var i = inc_var; i < params.content.length; i++) {
    ...
    function click_show_more(params,wrapper1) {
      console.log(params.content.length);
      //var inter = H5P.jQuery("#h5p-iframe-"+id).contents().find("#slider-custom-"+params.content[0].subContentId+" .slide").length+1;
      var inter = H5P.jQuery("#slider-custom-"+params.content[0].subContentId+" .slide").length;
      console.log('inter'+inter);
      if(inter >= params.content.length) {
        alert('No more videos to show'); return false;
      }
      process_runable(params,inter,wrapper1);
      // Attach instances that have not been attached
      console.log(instanceContainersSlider);
      console.log(instances);
      instanceContainersSlider.filter(function (container) { return !container.hasAttached })
        .forEach(function (container) {
          console.log(container);
          console.log(container.instanceIndex);
