...
var GGBApplet = function () {
  ...
  var setDefaultHTML5CodebaseForVersion = function (version, offline) {
    ...
    if (index > 0) {
      ...
      codebase = "https://www.geogebra.org/apps/5.0.593.0/"
    }
...
GGBAppletUtils.makeModule = function (name, permutation) {
  function webModule() {
    ...
    B();
    webModule.__moduleBase = "https://www.geogebra.org/apps/5.0.593.0/" + name + "/";
...
if (typeof window.web3d !== "function") {
  web3d = GGBAppletUtils.makeModule("web3d", "13A189CD807DC2F933F34C9D9D9B6172")
}
if (typeof window.webSimple !== "function") {
  webSimple = GGBAppletUtils.makeModule("webSimple", "108861FED24EFBF41AACC78877E7914D")
}
