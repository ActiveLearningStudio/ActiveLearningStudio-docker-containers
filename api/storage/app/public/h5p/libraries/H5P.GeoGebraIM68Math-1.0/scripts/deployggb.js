...
var GGBApplet = function () {
  ...
  var setDefaultHTML5CodebaseForVersion = function (version, offline) {
    ...
    if (index > 0) {
      ...
      codebase = "https://www.geogebra.org/apps/5.0.598.0/"
    }
...
GGBAppletUtils.makeModule = function (name, permutation) {
  function webModule() {
    ...
    B();
    webModule.__moduleBase = "https://www.geogebra.org/apps/5.0.598.0/" + name + "/";
...
if (typeof window.web3d !== "function") {
  web3d = GGBAppletUtils.makeModule("web3d", "B56FA9DA38E57C4D6AC73C16518139D3")
}
if (typeof window.webSimple !== "function") {
  webSimple = GGBAppletUtils.makeModule("webSimple", "1AF7DB3E6A99AA31E24239AE03079C91")
}
