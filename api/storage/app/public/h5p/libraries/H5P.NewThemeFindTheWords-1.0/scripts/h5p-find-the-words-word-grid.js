(function (NewThemeFindTheWords, EventDispatcher, $) {
   ...
   * @class H5P.NewThemeFindTheWords.WordGrid
   * @extends H5P.EventDispatcher
   * @param {Object} params Description.
   */
  NewThemeFindTheWords.WordGrid = function (params) {
    /** @alias H5P.NewThemeFindTheWords.WordGrid# */
  ...
  NewThemeFindTheWords.WordGrid.prototype = Object.create(EventDispatcher.prototype);
  NewThemeFindTheWords.WordGrid.prototype.constructor = NewThemeFindTheWords.WordGrid;
  ...
  const mouseMoveEventHandler = function (e, canvas, srcPos, eSize) {
   ...
   context.moveTo(srcPos[0] - (eSize / 8), srcPos[1] + (offsetTop / 2));
  ...
  NewThemeFindTheWords.WordGrid.prototype.createWordGrid = function () {
    let wordGrid = null ;
    let attempts = 0;
   ...
   */
  NewThemeFindTheWords.WordGrid.prototype.markWord = function (wordParams) {
    ...
    const bottomRadius = Math.abs(Math.floor(offsetTop / 2));
    const lineWidth = Math.floor(this.elementSize / 3);
   ...
   */
  NewThemeFindTheWords.WordGrid.prototype.mark = function (wordList) {
   ...
   */
  NewThemeFindTheWords.WordGrid.prototype.markSolution = function (solutions) {
    const that = this;
   ...
   * disableGrid.
   */
  NewThemeFindTheWords.WordGrid.prototype.disableGrid = function () {
   ...
   * enableGrid.
   */
  NewThemeFindTheWords.WordGrid.prototype.enableGrid = function () {
   ...
   */
  NewThemeFindTheWords.WordGrid.prototype.appendTo = function ($container, elementSize) {
   ...
   */
  NewThemeFindTheWords.WordGrid.prototype.drawGrid = function (margin) {
    const that = this;
    ...
    that.wordGrid.forEach(function (row, index1) {
      row.forEach(function (element, index2) {
        ...
        ctx1.fillStyle = "#E7E0CA";
        ctx1.fillStyle = "#FFFFFF";
        roundRect(ctx1, index2 * that.elementSize + 2 * marginResp-10, index1 * that.elementSize + (offsetTop)-20, 50, 50, 10, true);
        ctx1.fillStyle = "black";
        ctx1.fillText(element.toUpperCase(), index2 * that.elementSize + 2 * marginResp+5, index1 * that.elementSize + (offsetTop)+10 );
      });
    });
  ...
  return NewThemeFindTheWords.WordGrid;
...
function randomColor(){
    const color = ["255,0,0,0.6", "0,255,0,0.6", "0,0,255,0.6", "178,19,181,0.6", "255,255,0,0.6", "255,0,255,0.6"];
